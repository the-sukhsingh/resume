...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white font-sans text-neutral-900 dark:bg-black dark:text-neutral-50 max-w-5xl mx-auto border-x border-dashed border-neutral-300 dark:border-neutral-800  overflow-visible nobar">
